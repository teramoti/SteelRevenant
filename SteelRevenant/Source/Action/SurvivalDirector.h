...
namespace Action
{
	...
	private:
		...
		int BuildWaveEnemyCount(int waveIndex) const;
		int BuildWaveAliveCap(int waveIndex) const;
	...
	private:
		...
		float m_waveBreakTimerSec;
		float m_waveBreakDurationSec;
		int m_currentWave;
		int m_totalWaveCount;
		int m_waveEnemyQuota;
		int m_waveSpawnedCount;
		bool m_waveBreak;
		bool m_completed;
	};
}
